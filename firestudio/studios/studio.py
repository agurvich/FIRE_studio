...
shared_kwargs = [
    ...
    'scale_bar_length=', ##None - length of scalebar in data space
...
class Studio(object):
    ...
    Optional:
        ...
        scale_bar=1 - should you plot a scale bar in the bottom left corner
        scale_bar_length=None - length of scale bar in data space. Defaults to reasonable choices.
    ...
    def __init__(
        ...
        scale_bar_length = None, ## length of the scale bar.
